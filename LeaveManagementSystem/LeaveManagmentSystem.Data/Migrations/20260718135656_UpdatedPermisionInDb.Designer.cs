...
namespace LeaveManagmentSystem.Data.Migrations
{
    ...
    [Migration("20260718135656_UpdatedPermisionInDb")]
    partial class UpdatedPermisionInDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeaveManagementSystem.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$flY5M6QZfoX/JyYKafJR6uzkmsCsQALsiA1zWxhlL3i7mHeCxOvmC",
                            Role = 0
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$iKmdmIxwr5k4MvBbWXgt9usmrld42/jG6/ayulDM5MkgwXFjb.xJa",
                            Role = 1
                        },
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$unNNQj2Fqc8cK2jsmK43Te49CQfjAMsH1BW7vm8oZ/Li5t4RmEWLO",
                            Role = 2
                        });
                });
